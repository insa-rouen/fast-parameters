...
DLC 1.1 NTM @ ?? m/s for NREL 5.0 MW Baseline Wind Turbine (Onshore)
---------------------- SIMULATION CONTROL --------------------------------------
False         Echo            - Echo input data to <RootName>.ech (flag)
"FATAL"       AbortLevel      - Error level when simulation should abort (string) {"WARNING", "SEVERE", "FATAL"}
      10860   TMax            - Total run time (s) at least 10min
...
"DLC1.1_NTM_*.IW.dat"      InflowFile      - Name of file containing inflow wind input parameters (quoted string)
