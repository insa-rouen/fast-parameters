...
DLC 1.1 NTM @ 23 m/s for NREL 5.0 MW Baseline Wind Turbine (Onshore)
---------------------- SIMULATION CONTROL --------------------------------------
...
"DLC1.1_NTM_23mps.IW.dat"      InflowFile      - Name of file containing inflow wind input parameters (quoted string)
