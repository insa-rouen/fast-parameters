...
def readcsv(filename, delimiter='\t', header=7, datarow=9, unitrow=None, echo=True):
    ...
    dataframe = pandas.read_csv(filename, delimiter=delimiter, 
        encoding='ISO-8859-1', header=header, skip_blank_lines=False)
...
def add_failed_seeds(programName, identity):
    ''' Collect simulation identities (seed ID, filebase name, ...) that has an 
