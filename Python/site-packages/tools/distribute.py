...
class LMN(object):
    ...
    def __init__(self, windPath, echo=True):
        ...
        self._timeRatio['PC-LMN-7010A'] = 1655 # Hao BAI
        self._timeRatio['PC-LMN-7010B'] = 1812 # Hao BAI
        self._timeRatio['PC-LMN-7040'] = 1361 # 1TB
        self._timeRatio['PC-LMN-9010'] = 1915 # Changwu HUANG
        self._timeRatio['PC-LMN-1600A'] = 1257 # Surke ALJAMEL
        self._timeRatio['PC-LMN-1600B'] = 1257 # Corentin LOTHODE
        self._timeRatio['PC-LMN-9020A'] = 1505
        self._timeRatio['PC-LMN-9020B'] = 1505
        self._timeRatio['PC-LMN-7050'] = 1369 # Chao REN
        self._timeRatio['PC-LMN-9020'] = 1600 # Shubiao WANG
        if platform.node() == 'MacBook-Pro-de-Hao.local': # only for testing
