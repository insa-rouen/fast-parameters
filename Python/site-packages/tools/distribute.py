...
class LMN(object):
    ...
    def __init__(self, windPath, echo=True):
        ...
        self._timeRatio['PC-LMN-7010A'] = 4192 # Hao BAI
        self._timeRatio['PC-LMN-7010B'] = 4192 # Hao BAI
        self._timeRatio['PC-LMN-7040'] = 3440 # 1TB
        self._timeRatio['PC-LMN-9010'] = 4512 # Changwu HUANG
        self._timeRatio['PC-LMN-1600A'] = 2818 # Surke ALJAMEL
        self._timeRatio['PC-LMN-1600B'] = 2821 # Corentin LOTHODE
        self._timeRatio['PC-LMN-9020A'] = 3550
        self._timeRatio['PC-LMN-9020B'] = 3546
        self._timeRatio['PC-LMN-7050'] = 3800 # Chao REN
