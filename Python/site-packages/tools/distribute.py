...
class LMN(object):
    ...
    def __init__(self, windPath, echo=True):
        ...
        self._timeRatio['PC-LMN-7010A'] = 3958 # Hao BAI
        self._timeRatio['PC-LMN-7010B'] = 3856 # Hao BAI
        self._timeRatio['PC-LMN-7040'] = 3186 # 1TB
        self._timeRatio['PC-LMN-9010'] = 4190 # Changwu HUANG
        self._timeRatio['PC-LMN-1600A'] = 2616 # Surke ALJAMEL
        self._timeRatio['PC-LMN-1600B'] = 2616 # Corentin LOTHODE
        self._timeRatio['PC-LMN-9020A'] = 3294
        self._timeRatio['PC-LMN-9020B'] = 3294
        self._timeRatio['PC-LMN-7050'] = 3201 # Chao REN
        self._timeRatio['PC-LMN-9020'] = 3333 # Shubiao WANG
        if platform.node() == 'MacBook-Pro-de-Hao.local': # only for testing
