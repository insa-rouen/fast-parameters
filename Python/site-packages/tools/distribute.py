...
class LMN(object):
    ...
    def __init__(self, windPath, echo=True):
        ...
        self._timeRatio['PC-LMN-7010A'] = 4239.15 # Hao BAI
        self._timeRatio['PC-LMN-7010B'] = 4259.70 # Hao BAI
        self._timeRatio['PC-LMN-7040'] = 3441.02 # 1TB
        self._timeRatio['PC-LMN-9010'] = 4509.62 # Changwu HUANG
        self._timeRatio['PC-LMN-1600A'] = 2810.81 # Surke ALJAMEL
        self._timeRatio['PC-LMN-1600B'] = 2819.64 # Corentin LOTHODE
        self._timeRatio['PC-LMN-9020A'] = 3545.01
        self._timeRatio['PC-LMN-9020B'] = 3544.53
        self._timeRatio['PC-LMN-7050'] = 3442.31 # Chao REN
        self._timeRatio['PC-LMN-9020'] = 3649.80 + 200 # Shubiao WANG
        if platform.node() == 'MacBook-Pro-de-Hao.local': # only for testing
