...
class LMN(object):
    ...
    '''
    def __init__(self, windPath, outputPath, testmode=False, echo=True):
    ...
    def resume(self, programName='TurbSim', outputFileSize=None):
        print("========== Resume Mode ==========")
        ...
        if programName.lower() == 'TurbSim'.lower():
            ...
            self._length[self._currentComputer] = len(
                self._nodes[self._currentComputer])
            newTasks = self._nodes.get(self._currentComputer)
            print("{} tasks were affected to this computer, {} tasks haven't "
                  " been finished by TurbSim".format(len(oldTasks),
                  len(newTasks)))
            ...
            newTasks = self._nodes.get(self._currentComputer)
            print("{} tasks were affected to this computer, {} tasks haven't "
                  " been finished by Fatigue".format(len(oldTasks),
                  len(newTasks)))
