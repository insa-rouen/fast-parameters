...
class Fatigue(object):
    ...
    def assessAllStressSpot(self):
        ...
        list(map(self.assessStressSpot, self.spotNames))
    ...
    def assess_multiprocess(self,):
        ...
        # [pool.apply_async(self.assessStressSpot, args=(spot,)) for spot in self.spotNames]
        pool.map_async(self.assessStressSpot, self.spotNames)
        pool.close()
        pool.join()
