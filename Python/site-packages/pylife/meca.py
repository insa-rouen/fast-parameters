...
class Stress(object):
    ...
    '''
    def __init__(self, filebase, datarow, gages, thetaStep, echo):
...
#!                                      FUNCTIONS
#!----------------------------------------------------------------------------------------
def get_stress(filebase, datarow, gages, thetaStep=30, echo=False):
    temp = Stress(filebase=filebase, datarow=datarow, gages=gages, thetaStep=thetaStep,
                  echo=echo)
    return filebase

def get_stress_multiprocess(list_filebase, datarow, gages, thetaStep=30, echo=False):
    print('Stress v0.5 (November 5 2018)')
    ...
    [pool.apply_async(get_stress, args=(filebase, datarow, gages, thetaStep, echo),
