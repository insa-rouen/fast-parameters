...
def auto(numberOfSeeds, speedRange, allowDuplicate=False, reuseSeed=False,):
    ...
    if reuseSeed is False:
                    ...
                    if allowDuplicate is False:
                        while True:
                            ...
                            if seed in temp or seed in history:
                                print("|- [ALERT] Random number {} is repeated,"
                                    " a new one will be regenerated".format(
                                    seed))
                            else:
                                break
                    else:
        ...
        for i in range(numberOfSeeds):
            if allowDuplicate is False:
                ...
                seed = random.randint(-2147483648, 2147483647)
            temp.append(seed)
        data = [(key, str(v), str(seed)) for key in ('NTM', 'ETM')
