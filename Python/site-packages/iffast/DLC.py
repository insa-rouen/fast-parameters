...
class DLC(object):
    ...
    def _fast(self, silence):
        ...
        if wrong:
            ...
            filename = self.logPath.joinpath('{}.FAST.bug'.format(self.seed[2]))
            filename.write_bytes(errorMessage)
            utils.add_failed_seeds('FAST', self.seed)
...
def get_DLC11_multiprocess(list_seed, outputFolder='', silence=False,
    ...
    def printer(seed):
        ...
        print('|- [{}/{}] Simulation for {} wind at {} m/s with seed ID {} is terminated '
              'at {}:{}. {} tasks waiting to be completed ...'.format(pos, length, seed[0], seed[1], seed[2], hour, minute, rest))
