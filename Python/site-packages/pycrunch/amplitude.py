...
class PeakValleyFinder(object):
    ...
    def run(self):
        ...
        self.dataInput = utils.readcsv(filename=self.filebase+'.out', 
            header=self.header, datarow=self.datarow,
            echo=self.echo)
        ...
        if self.echo:
            print("|- The peak and valley of channel {} in {} are exported !"
                .format(self.channels, self.filebase))
...
class Amplitude(object):
    ...
    @classmethod
    def max_p2p_amplitude(self, list_filebase, channels, extension='.ext', 
        echo=False):
