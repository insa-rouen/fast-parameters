...
class Analysis(object):
    ...
    def _damageOnSpot(self):
        for v in self.listOfSpeed:
            ...
            spotNames = set(data)
            temp = [(name, data.count(name)) for name in spotNames]
            self.dataInput[v]['Occurence'] = sorted(temp, key=lambda x:x[1], reverse=True)
    ...
    def plotMaxDamageCounts(self, toPDF=[]):
        ...
        fig.suptitle('Counts of max damage at different wind speed')
