...
class Lifetime(object):
    ...
    """
    def __init__(self, measure_data, measure_duration, wind_speed_range,
        distribution_directory, quantile, simulated_time):
        self.measure_data = measure_data
        self.measure_duration = measure_duration
        self.wind_range = wind_speed_range
        self.distr_dir = Path(distribution_directory)
    ...
    def calculate_damage_direction(wind_direction_time, unit_damage,
        ...
        multiplication = pandas.DataFrame(amplifier.values * 
