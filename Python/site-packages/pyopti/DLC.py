...
class TRD(DLC.DLC23):
    ...
    def __init__(self, mode1, gridloss, case, outputFolder='',
        ...
        self.outputFilename = ""
        self._tmpPath = None
        self._name_suffix = RNG.randint(2**32-1)
    ...
    def _change_TRD(self):
        ...
        filename = self.tmpPath.joinpath('{}_{}_{}_{}_{}.fst'.format(self.case,
            self.gridloss[0], self.gridloss[1], self.__id, self._name_suffix))
    ...
    def _move(self):
        ...
        source = self.tmpPath.joinpath('{}_{}_{}_{}_{}.out'.format(self.case,
            self.gridloss[0], self.gridloss[1], self.__id, self._name_suffix))
