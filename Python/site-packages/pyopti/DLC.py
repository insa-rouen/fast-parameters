...
class TRD(DLC.DLC23):
    ...
    def _change_TRD(self):
        ...
        filename = self.tmpPath.joinpath('ServoDyn_DLC2.3_{}.dat'
                                        .format(self.__id))
        filename.open('w').writelines(data)
        ...
        source = self.workPath.joinpath('DLC2.3_EOG_O.IW.dat')
        destination = self.tmpPath.joinpath('DLC2.3_EOG_O.IW.dat')
        utils.cp(source, destination)
