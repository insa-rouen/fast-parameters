...
DLC 1.3 ETM @ 11 m/s for NREL 5.0 MW Baseline Wind Turbine (Onshore)
---------------------- SIMULATION CONTROL --------------------------------------
...
---------------------- FEATURE SWITCHES AND FLAGS ------------------------------
          ...
          1   CompAero        - Compute aerodynamic loads (switch) {0=None; 1=AeroDyn; 2=AeroDyn v15}
...
"DLC1.3_ETM_11mps_IW.dat"      InflowFile      - Name of file containing inflow wind input parameters (quoted string)
