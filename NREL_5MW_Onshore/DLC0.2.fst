...
DLC 0.2 with still air for NREL 5.0 MW Baseline Wind Turbine (Onshore) 
---------------------- SIMULATION CONTROL --------------------------------------
False         Echo            - Echo input data to <RootName>.ech (flag)
"FATAL"       AbortLevel      - Error level when simulation should abort (string) {"WARNING", "SEVERE", "FATAL"}
        100   TMax            - Total run time (s) > 40s + transient duration
...
---------------------- INPUT FILES ---------------------------------------------
"WT/DLC0.2_ElastoDyn.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
