...
"FATAL"       AbortLevel      - Error level when simulation should abort (string) {"WARNING", "SEVERE", "FATAL"}
        120   TMax            - Total run time (s) > 40s + transient duration
...
"DLC0.1_InflowWind.dat"      InflowFile      - Name of file containing inflow wind input parameters (quoted string)
"DLC0.1_AD.dat"    AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
