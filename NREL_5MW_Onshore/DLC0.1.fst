...
DLC 0.1 at uniform wind speed for NREL 5.0 MW Baseline Wind Turbine (Onshore) 
---------------------- SIMULATION CONTROL --------------------------------------
...
"DLC0.1_IW.dat"      InflowFile      - Name of file containing inflow wind input parameters (quoted string)
